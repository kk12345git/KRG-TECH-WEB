            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    ...
                    {categoriesData.map((category) => (
                        ...
                        >
                            <Link
                                ...
                                className="w-full aspect-[16/11] rounded-[2.5rem] overflow-hidden bg-slate-100 mb-8 border border-slate-100 hover-lift relative"
                            >
                                <img
                ...
                <div className="bg-slate-50 rounded-[3rem] p-16 lg:p-24 mb-32 relative overflow-hidden text-center">
                    ...
                    <div className="relative z-10">
                        ...
                        <Link to="/customization" className="px-12 py-6 bg-medical-700 text-white rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-medical-900 shadow-2xl shadow-medical-700/20 transition-all hover:scale-105">
                            Configure Solution
                        </Link>
                    </div>
                </div>
