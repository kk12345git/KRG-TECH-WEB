...
import { ArrowLeftIcon, MagnifyingGlassIcon, AdjustmentsHorizontalIcon, PlusIcon, EyeIcon } from '@heroicons/react/24/outline';
    ...
    return (
        <div className="bg-white min-h-screen pb-24 pt-32">
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8 mb-20">
                <Link to="/products" className="inline-flex items-center gap-2 text-slate-400 text-[10px] font-black uppercase tracking-widest mb-10 hover:text-medical-700 transition-colors">
                    ...
                    <div className="flex-grow">
                        <div className="grid grid-cols-1 gap-x-12 gap-y-16 sm:grid-cols-2 lg:grid-cols-3">
                            {(filteredResults.length > 0 ? filteredResults : []).map((product) => (
                                ...
                                >
                                    <div className="aspect-[4/3] w-full rounded-[2.5rem] bg-slate-50 overflow-hidden border border-slate-50 hover-lift mb-8 relative">
                                        <img
                                    ...
                                    <Link to={`/product/${product.id}`} className="w-full">
                                        ...
                                        <p className="text-sm text-slate-400 italic mb-8 line-clamp-2">
                                            {product.description}
                                        </p>
                                    </Link>
                                </div>
