                ...
                >
                    ...
                    <div className="hidden lg:flex shrink-0 items-center">
                        ...
                        <button
                            ...
                            className={`ml-4 relative p-3 rounded-xl transition-all hover:scale-110 active:scale-95 border ${!isScrolled && isDarkPage 
                                ? 'bg-white/10 text-white border-white/20' 
                                : 'bg-slate-50 text-slate-900 border-slate-200 shadow-sm'}`}
                        >
                            <ShoppingBagIcon className="w-5 h-5" />
                            {cartCount > 0 && (
                                <span className="absolute -top-1 -right-1 flex h-5 w-5 items-center justify-center rounded-full bg-medical-600 text-[10px] font-black text-white ring-2 ring-white">
                                    {cartCount}
                                </span>
                            )}
                        </button>
