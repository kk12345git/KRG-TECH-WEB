...
import { getLeads, updateLeadStatus } from '@/lib/actions';
import {
    MailIcon,
    Building2Icon,
    CalendarIcon,
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
                ...
                <div className="flex gap-4">
                    <button 
                        ...
                        title="Refresh list"
                    >
                        <RefreshCwIcon className={cn("w-5 h-5 text-slate-500", loading && "animate-spin")} />
                    </button>
                                ...
                                <tr>
                                    <td colSpan="6" className="px-8 py-20 text-center">
                                        <div className="flex flex-col items-center gap-4">
                                            <RefreshCwIcon className="w-8 h-8 text-medical-500 animate-spin" />
                                ...
                                >
                                    <td className="px-8 py-6">
                                        <div className="flex items-center gap-4">
                                            <div className="w-10 h-10 rounded-full bg-medical-50 flex items-center justify-center text-medical-700 font-black text-xs uppercase">
                                    ...
                                    <td className="px-8 py-6">
                                        <select 
                                            ...
                                            className={cn(
                                                "px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-widest border bg-transparent cursor-pointer outline-none",
