    ...
    return (
        <div className="bg-white min-h-screen">
            ...
            <div className="bg-slate-900 py-32 text-white relative overflow-hidden">
                ...
                <div className="mx-auto max-w-7xl px-8 lg:px-16 relative z-10 text-center lg:text-left">
                    <motion.div
                    ...
                    >
                        ...
                        <h1 className="text-5xl font-black sm:text-7xl tracking-tighter uppercase mb-8 leading-[0.9]">
                            Defining the <br /><span className="text-medical-500">Sterile Standard.</span>
                        </h1>
            ...
            <div className="bg-slate-50 py-32 border-y border-gray-100">
                <div className="mx-auto max-w-7xl px-8 lg:px-16 text-center">
                    ...
                    <p className="max-w-2xl mx-auto text-slate-500 leading-relaxed mb-16 px-4">
                    ...
                    <div className="aspect-video bg-slate-200 rounded-[3rem] overflow-hidden relative shadow-2xl mx-4 lg:mx-0">
                        <Image
