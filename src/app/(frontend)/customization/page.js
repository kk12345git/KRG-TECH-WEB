    ...
    return (
        <div className="bg-white min-h-screen pt-32">
                ...
                <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="mt-10">
                                <Link href="/contact" className="bg-medical-500 text-white px-8 py-4 rounded-lg font-bold hover:bg-medical-400 transition-colors">
            ...
            <div className="py-24 text-center">
                ...
                <Link href="/contact" className="inline-block bg-medical-700 text-white px-10 py-4 rounded-md font-bold hover:shadow-xl transition-all">
                    Start Consultation
                </Link>
            </div>
        </div>
