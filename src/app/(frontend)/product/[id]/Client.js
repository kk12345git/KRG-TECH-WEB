...
export default function ProductDetailClient({ product, productsData }) {
    ...
    return (
        <div className="bg-white min-h-screen pb-32 pt-32">
            <SEO
                title={`${product.title} | KRG Technical Specification`}
                description={`Technical specifications for ${product.title}. Clinical-grade ${product.material} construction. Manufactured by KRG Medifabb.`}
            />
                ...
                <div className="lg:grid lg:grid-cols-2 lg:gap-x-24">
                    ...
                    <div className="relative group">
                        ...
                        <div className="relative z-10">
                            {is3D ? (
                                <Product3DViewer name={product.title} posterUrl={product.image} />
                            ) : (
                    ...
                    <div className="mt-16 lg:mt-0">
                        ...
                        <h1 className="text-5xl lg:text-7xl font-black tracking-tighter text-slate-900 uppercase leading-[0.85] mb-10">{product.title}</h1>
